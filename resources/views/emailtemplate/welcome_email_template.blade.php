    ...
    <tbody>
        ...
        <tr>
            ...
            <td colspan="2" style="border-left:1px solid #000; border-right:1px solid #000; border-top:1px solid #000; border-bottom:1px solid #000; padding:10px 20px;">
                  ...
                  <span style="font-weight:bold;display:inline-block;min-width:146px"> {{$details['hi_message']}} </span> 
        ...
        <tr>
            ...
            <td colspan="2" style="border-left:1px solid #000; border-right:1px solid #000; border-top:1px solid #000; border-bottom:1px solid #000; padding:10px 20px;">
                  ...
                  <span style="font-weight:bold;display:inline-block;min-width:146px"> THANKYOU FOR SIGNUP </span> 
